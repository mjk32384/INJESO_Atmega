...
int main(void) {
	...
	while (1) {
		...
		UART1_transmit_int16((int16_t)mag[0]); UART1_transmit_string(",");
		UART1_transmit_int16((int16_t)mag[1]); UART1_transmit_string(",");
		UART1_transmit_int16((int16_t)mag[2]); UART1_transmit_string("\n");
	}
}
